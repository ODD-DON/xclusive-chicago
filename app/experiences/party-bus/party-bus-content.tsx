...
import { ArrowLeft, Bus, Users, Clock, Music, Check, MapPin, Minus, Plus, Wine } from 'lucide-react'
...
// bottle service, which is what actually needs to be quoted per club/date.
const PACKAGES = [
  {
    id: 'standard',
    name: 'Standard',
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          {[
            ...
            { icon: Wine, label: 'Free club access included' },
